...
::: {.callout-tip}
By definition, the majority of observed data points cannot be outliers. We can have noisy data. What we are looking for are data points that might be pulling the relationship in a strange direction.  
:::
...
::: {.callout-tip}
This is not a professionally formatted table. You could not include this in a journal article. I suggest using `modelsummary::modelsummary()`. 
:::
...
::: {.callout-tip}
Correct. Also always good to note whether the intercept is meaningful by itself.  
:::
...
::: {.callout-tip}
Correct. More precise to say "on average" rather than "tends to". 
:::
...
::: {.callout-tip}
Kind of. This is the observed coefficient's t statistic. The t-statistic assumes that we are in the null world.   
:::
