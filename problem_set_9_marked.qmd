...
::: callout-tip
Your professional tables should always include variable labels that are meaningful for the reader.
:::
...
::: callout-tip
This is a cool approach, but it does not isolate the predicted effect of `pcthsg` on `vote`. This is a purely an aesthetic problem, not a conceptual one. I recommend using `marginaleffects::plot_predictions()` to answer this question.
:::
