...
::: {.callout-tip title="HG comments"}
10/10. Thorough answer. Well done.
:::
...
This question has two parts, one to see the effects of network media vs print media in shaping government trust. The second part of the question wants see if this effect is the greatest amongst 'young' citizens.
...
A. 1. Sampling Variability: The sample is not randomized at at and draws from only a section of the world. It also does not address if a country was a democracy or not at the time of the observation.

::: {.callout-tip title="HG comments"}
The sampling variability of a statistic refers to how much the statistic varies from sample to sample. This sample will have no sampling variability. If I pull repeated samples of educational funding levels for every country in Europe for each of the last 100 years, I will get the same values each sample. There will be no variability.
:::

Source of Bias: The effects of Europe cannot be generalized to the world. The recording of education will also be biased by not taking into account if the country was a democracy or not.
...
::: {.callout-tip title="HG comments"}
A statistic is biased if the long-term average value of the statistic is not the parameter it is estimating. If we were to take many, many different 5 country random samples, our estimate of funding of education institutions should approach that of the population. This sample is not biased.
:::
...
::: {.callout-tip title="HG comments"}
If we were to administer many different surveys of all educational administrators in these countries, we should get very similar responses each time. If we only surveyed a sample of all educational administrators in these countries, we might get more sample variability; however, you would need to specify that this was a sample of those administrators.
:::
...
::: {.callout-tip title="HG comments"}
Correct that Russia may not be representative of all non-democracies and the US may not be representative of demoracies, so our estimate of their levels of funding of education institutions may be different from that of our population.
:::
...
::: {.callout-tip title="HG comments"}
This is a high proportion of our populations (democracies and non-democracies), so we should see similar estimates from repeated random samples of 75 countries. There should be low sampling variation.
:::
...
::: {.callout-tip title="HG comments"}
This is more a point about sampling variability. The random sample of a countries globally should, on average, reflect the distribution of democracies/non-democracies globally. We should therefore, on average, get roughly 25 non-democracies in our random sample (1/3 of 75). This may not be a large enough sample to get an accurate sense of the level of funding of education institutions of non-democracies.
:::
...
::: {.callout-tip title="HG comments"}
This phrasing suggests that you should look across columns, rather than rows. For example, within the 61+ yo category (of which there were 100), 55% voted for Kerry and 45% voted for Bush. Within the 18-30 yo group (of which there were 73), `r scales::percent(42/73)` voted for Kerry and `r scales::percent(31/73)` voted for Bush. But you have provided the right interpretation of the hypothesis.
:::

A. Conditional distribution for Kerry is 16% among 41-50 category

::: {.callout-tip title="HG comments"}
The question asks for the conditional distribution of respondents who are 41-50 that voted for Kerry. In other words, what is the proportion of 41-50 year olds who voted for Kerry? 30 of the 70 (or `r round(30/70, 2)`) 41-50 year olds in the survey voted for Kerry.
:::

B. Conditional distribution for Bush is 20.4% among the 41-50 category

::: {.callout-tip title="HG comments"}
40 of the 70 (or `r round(40/70, 2)`) 41-50 year olds in the survey voted for Bush.
:::
