...
::: callout-tip
The Chi-square statistic is 6.09. The difference appears to be a manual calculation error, not a misunderstanding.
:::
...
::: callout-tip
Remember to always look at the proportions within groups. Avoids spurious findings based only on larger populations.
:::
